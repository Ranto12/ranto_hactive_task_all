    ...
    return (
     <div className='h-16 bg-navbar w-full fixed shadow-xl bg-opacity-70 backdrop-blur-sm'>
        <div className='flex px-10'>
            ...
            <span className='font-bold text-3xl '>QTemu</span>
            <span className='font-normal text-xl opacity-75'>Create MeetUp</span>
            <span className='font-normal text-xl opacity-75'>Explore</span>
            </div>
            <div className='w-2/3 bg'>
              <div className='flex justify-end w-full items-center  h-16  text-white'>
                <span className='font-normal text-xl opacity-75'>Login</span>
              </div>
            </div>
        </div>
     </div>
